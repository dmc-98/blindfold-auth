...
Use these together when working through the roadmap:

1. `ROADMAP.md`
2. `docs/PHASE_0_CHECKLIST.md`
3. `docs/contracts/API_CONTRACT.md`
4. `docs/contracts/CLI_CONTRACT.md`
5. `docs/contracts/STORAGE_CONTRACT.md`
6. `docs/contracts/CONFIG_CONTRACT.md`
7. `docs/contracts/DEPLOYMENT_MATRIX.md`
8. `docs/THREAT_MODEL.md`
9. `docs/SECURITY_AUDIT.md`
10. `docs/PERFORMANCE.md`
11. `docs/ARCHITECTURE.md`
12. `docs/GO_LIVE.md`
13. `docs/LAUNCH_ASSETS.md`
14. `docs/RELEASE_NOTES_RC1.md`

## Repository map

- `README.md`: short entry point and quick start
- `ROADMAP.md`: phased development and release plan
...
- `docs/GO_LIVE.md`: deployment and public launch runbook
- `docs/LAUNCH_ASSETS.md`: reproducible screenshot and GIF capture plan
- `docs/RELEASE_NOTES_RC1.md`: launch-ready release copy
- `docs/THREAT_MODEL.md`: current trust boundaries and security goals
- `docs/SECURITY_AUDIT.md`: current audit findings and fixes
...
- `docs/PHASE_0_CHECKLIST.md`: Phase 0 implementation checklist
...
The security baseline is additionally documented in:
...
6. use `docs/GO_LIVE.md` before a public release or first real deploy
